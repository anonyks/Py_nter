"""Eye-dropper (colour picker) tool - click to sample a colour from the canvas."""
...
class EyeDropperTool(Tool):
    """
    Click on the canvas to pick the colour under the cursor and
    set it as the active drawing colour.  The closest palette
    entry is selected, or if no exact match the raw colour is
    pushed into the first palette slot so you can still use it.
    """
